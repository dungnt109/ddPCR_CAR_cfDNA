...
\fancypagestyle{plain}{%
  ...
  \fancyhf{}%
  \fancyfoot[C]{\footnotesize Page \thepage\, of\, \pageref*{LastPage} `r params$sid` `r params$mid` Generated at `r params$date` by ddPCR CAR Pipeline Version 1.0, 29 Aug 2024}
...
3. Assay Controls for CAR Assay 
